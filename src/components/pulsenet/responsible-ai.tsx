...
function deltaStyle(d: number): string {
  if (d < 0.15) return 'text-zinc-300'
...
export function ResponsibleAIPanel({
  ...
  return (
    <div className="space-y-2">
      {/* Governance stance */}
      <div className="rounded-lg border border-zinc-400/30 bg-zinc-400/[0.04] p-3">
        ...
        <div className="mt-2 grid gap-2 text-[11px] leading-relaxed text-muted-foreground sm:grid-cols-3">
          <div className="flex items-start gap-1.5">
            <UserCheck className="mt-0.5 h-3.5 w-3.5 shrink-0 text-zinc-300" />
            <span>
